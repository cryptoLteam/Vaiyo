  ...
  function HoldOnAction() {
    ...
    HoldOn.open = function (properties) {
      ...
      switch (theme) {
        case "custom":
          content =
            '<div style="text-align: center;">' + properties.content + "</div>";
          break;
        case "sk-dot":
          content =
      ...
      var Holder =
        '<div id="holdon-overlay" style="display: none;"><div id="holdon-content-container"><div id="holdon-content">' +
        content +
        '</div><div id="holdon-message">' +
        message +
        "</div></div></div>";
